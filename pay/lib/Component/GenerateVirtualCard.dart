...
class Generatevirtualcard {
  ...
  String generateNumber() {
    ...
    Random random =
        Random.secure(); // utilisation de secure pour des nombres sécurisés
    for (int i = 0; i < 15; i++) {
  ...
  Future<Map<String, dynamic>> generateCard(int userId) async {
    ...
    final String cvvNumber = generateCVV();
